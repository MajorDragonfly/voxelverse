...
const PHASES: Array[Dictionary] = [
	...
	{"name": "Stamm", "scope": "Drei Bewohner und ihr erstes Dorf", "implemented": true,
		...
		"next": "Dies ist die eigentliche Stammesphase. Dein Dorf kann einen Wurzelgarten anlegen und seine Nahrung dauerhaft sichern. Als Nächstes: weitere Berufe, zusätzliche Rohstoffquellen, Bevölkerungswachstum und Nachbarstämme."},

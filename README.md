...
Die zweite Integrationsrunde ergänzt B1–B3-Körperanschlüsse, D1–D3-Arten/Zähmung/Tierhaltung, erneuerbare Dorfwirtschaft mit Wachstum, Nachbarhilfe, gemeinsame Mini-/Weltkarte und die erste Deutsch-/Englisch-Verwaltung. Die gemeinsame Kugelkampagne unterstützt inzwischen Kreatur, Heimat, Stamm und Tierhaltung. Dauerhafte Körper-IDs, portionierter Wegeaufbau, begrenzte Fernarbeit und gesicherte Planetenwechsel bilden die nächste Skalierungsstufe. Der Kugelstart bleibt bis zur Ziel-PC-Abnahme ausdrücklich auswählbar; globales Speichern und lange Reisen sind weitere Skalierungsarbeiten. [Umsetzung, Messwerte und offene Grenzen](docs/WORK_CAMPAIGN_SCALING.md) · [Umzugsplan](docs/SPHERICAL_CAMPAIGN_MIGRATION.md).

## Projekt starten

`project.godot` mit Godot 4.6.3 öffnen und **F5 / Projekt ausführen** wählen. Das konfigurierte Startmenü `ui/frontend/main_menu.tscn` führt in die Kampagne. `main/main.tscn` und `main/spherical_campaign.tscn` sind die jeweiligen Spielwelten für gezielte Entwicklerprüfungen. Windows-/Linux-Exporte und ihre Prüfung sind in [DESKTOP_EXPORT.md](docs/DESKTOP_EXPORT.md) beschrieben.

**Kugelkampagne testen:** Beim neuen Spiel **„Kugelwelt ausprobieren“** aktivieren. **Pause → „Reiseziel wählen“** öffnet die Planeten desselben Systems. Für den Skalierungstest ein Dorf aufbauen, einen Gefährten arbeiten lassen, den Planeten wechseln und zurückkehren; Aufträge, Fracht und Bedürfnisse bleiben erhalten. Im Pausenmenü und bei geschlossener Anwendung läuft keine Fernproduktion.

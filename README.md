...
[Dashboard und nächste Prioritäten](docs/PROJECT_DASHBOARD.md) · [Zentrale Chat-Koordination](https://github.com/MajorDragonfly/voxelverse/issues/137) · [Spieltest-Kandidat #142](https://github.com/MajorDragonfly/voxelverse/pull/142)
...
Die zweite Integrationsrunde ergänzt B1–B3-Körperanschlüsse, D1–D3-Arten/Zähmung/Tierhaltung, erneuerbare Dorfwirtschaft mit Wachstum, Nachbarhilfe, gemeinsame Mini-/Weltkarte und die erste Deutsch-/Englisch-Verwaltung. Die gemeinsame Kugelkampagne unterstützt inzwischen Kreatur, Heimat, Stamm und Tierhaltung. Dauerhafte Körper-IDs, portionierter Wegeaufbau, begrenzte Fernarbeit und gesicherte Planetenwechsel bilden die nächste Skalierungsstufe. Die Kugelwelt ist der einzige reguläre Spielweg; Ziel-PC-Abnahme, globales Speichern und lange Reisen bleiben weitere Arbeiten. [Umsetzung, Messwerte und offene Grenzen](docs/WORK_CAMPAIGN_SCALING.md) · [Umzugsplan](docs/SPHERICAL_CAMPAIGN_MIGRATION.md).

## Projekt starten

`project.godot` mit Godot 4.6.3 öffnen und **F5 / Projekt ausführen** wählen. Das konfigurierte Startmenü `ui/frontend/main_menu.tscn` führt in die Kampagne. Die einzige reguläre Spielwelt ist `main/spherical_campaign.tscn`. Die alte Ebene liegt ausschließlich als historische Prüfszene unter `core/diagnostics/legacy_world.tscn`. Windows-/Linux-Exporte und ihre Prüfung sind in [DESKTOP_EXPORT.md](docs/DESKTOP_EXPORT.md) beschrieben.

**Kugelkampagne spielen:** „Neues Spiel“ startet direkt auf dem Kugelplaneten. Der frühere Auswahlhaken entfällt. Beim Fortsetzen unterstützter Flachweltstände entsteht eine geprüfte Kugelkopie; das Original bleibt erhalten. [Umstellung und offene Abnahmen](docs/WORK_SPHERE_ONLY_ENTRY.md). **Pause → „Reiseziel wählen“** öffnet die Planeten desselben Systems. Für den Skalierungstest ein Dorf aufbauen, einen Gefährten arbeiten lassen, den Planeten wechseln und zurückkehren; Aufträge, Fracht und Bedürfnisse bleiben erhalten. Im Pausenmenü und bei geschlossener Anwendung läuft keine Fernproduktion.

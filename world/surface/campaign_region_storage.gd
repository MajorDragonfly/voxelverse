...
func put(record_value: Dictionary, plant: bool = false) -> bool:
	...
	return _index(record_value, key, plant)
...
func move(record_value: Dictionary, location: Dictionary) -> bool:
	...
	var origin: Dictionary = region(pointer.get("region", ""), false)
	...
	return _index(record_value, key, false)

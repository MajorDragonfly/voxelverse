...
Die kleinen Kugeln bleiben Regressionstests. M1b betreibt jetzt drei Referenzkörper bis Erdgröße mit echten Voxelmeshes und Physik; [Messungen und Testbuild](docs/REAL_SCALE_PLANETS.md). Der schnelle Lauf kann an noch nicht vorbereiteten Kacheln warten. Nächste Optimierung: weniger entfernte Kacheln bei Flächenwechseln ersetzen und die Veröffentlichung aufteilen, ohne Naht- oder Kollisionslücken zu erzeugen. Danach ist der Lauf mit derselben Strecke, höchstens 4 m Zellenbreite und gemessenen Wartezeiten erneut zu prüfen.
...
**Nächste Arbeit im Planeten-/Weltraumzweig:** Ziel-PC-Rückmeldung für Fernwald und Inlandübergang einarbeiten; M1b-Nachladepausen und Veröffentlichungsspitzen weiter verkürzen. Vor späteren Galaxiereisen müssen Katalog-ID, tatsächlich geladenes System und persistenter Oberflächenort verbunden werden. Schiffe, Kolonien und die vollständige Weltraumspielschleife bleiben M9. Parallele Kreaturen-, Sozial-, Menü- und Soundarbeit bleibt auf ihren eigenen Branches.

...
**ARCH-24 – Mundmodellpaket (Fachbranch, 10. September):** Hundeschnauze, Krokodilschnauze und Oktopusmund sind als additive Alternativen der bestehenden Raubkiefer umgesetzt. Gemeinsamer Renderer, Silhouetten, erspielte Freischaltung und Neustartanschluss erhalten alte Arten/Entwürfe. [Umfang und Prüfnachweise](docs/WORK_ARCH24_MOUTH_MODELS.md). Rüssel, weitere Mundformen und eigenständige Kieferanimation bleiben offen; dieses Teilpaket ist noch kein vollständig abgeschlossener ARCH-24.

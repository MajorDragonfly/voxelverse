...
Auf Lars’ Wunsch wird die Gestaltung jetzt deutlich näher am Spore-Prinzip umgesetzt: Körperpunkte direkt ziehen, Volumen mit dem Mausrad formen, Teile auf den Körper ziehen, symmetrisch anbauen, Farben bestimmen und die Kreatur im Editor in Bewegung sehen. Nach Lars’ Präzisierung vom 9. September bleiben Körper, Teile und Arbeitsfläche in Voxeloptik. Die sichtbaren Würfelflächen sind zugleich die Trefferfläche zum Anbauen. [Voxel-Überarbeitung](docs/CREATURE_VOXEL_STYLE.md). Eigene Geometrie und Oberfläche; keine übernommenen Spore-Inhalte.

...
- Die Voxelgestaltung bleibt über Nahansicht, Landschaft, Städte und Planetenansicht erkennbar. Kreaturen bleiben auf Lars’ Wunsch vom 9. September ebenfalls in Voxeloptik; ihre Silhouette lässt sich direkt formen.
...
| Kreaturen | Separater M3A-Branch: Werkstatt mit direkter Körperformung, Teilekarten/Drag-and-drop, Farbe, Bewegungsvorschau und gemeinsamer Darstellung aus kleinen Voxeln; V7-Entwürfe, Symmetrie und Undo/Redo bleiben Grundlage | M3A integrieren und manuell spielen; Gelände-/Wasserfälle aller Körperpläne und vollständig wirksame Fähigkeiten | [Aktiver Editor](creatures/editor/creature_editor_runtime.gd), [Assembly V7](creatures/editor/creature_assembly_blueprint_v7.gd), [Runtime](creatures/runtime/creature_runtime_visual.gd) |
...
| M3 | **M3A separat technisch und visuell geprüft:** Kreaturen-Werkstatt und Darstellung; volle M3-Abnahme offen | M2; Laufzeit auf M1-Grundlage | Repräsentative Körperformen lassen sich verständlich gestalten und bewegen; Vorschau und Spiel stimmen überein; erste Körperfähigkeiten funktionieren |
...
### M3A – Kreaturen-Werkstatt im parallelen Branch geprüft

Auf Lars’ Wunsch wird die Gestaltung jetzt deutlich näher am Spore-Prinzip umgesetzt: Körperpunkte direkt ziehen, Volumen mit dem Mausrad formen, Teile auf den Körper ziehen, symmetrisch anbauen, Farben bestimmen und die Kreatur im Editor in Bewegung sehen. Nach Lars’ Präzisierung vom 9. September bleiben Körper, Teile und Arbeitsfläche in Voxeloptik. Das Kreaturenraster wurde anschließend weiter verfeinert: Körperzellen haben regulär ein Drittel, Anbauteile die Hälfte der bisherigen Kantenlänge. Die sichtbaren Würfelflächen sind zugleich die Trefferfläche zum Anbauen. [Voxel-Überarbeitung](docs/CREATURE_VOXEL_STYLE.md). Der anschließende [Teileausbau](docs/CREATURE_PARTS_STUDIO.md) ergänzt 29 überarbeitete Anbauteile, XYZ-Regler, Stachelsymmetrie und Mittelachse, sieben Hand-/Fußvarianten, gemeinsamen Sohlenstand und fünf kosmetische Hauttypen mit erweiterter Farbauswahl. Eigene Geometrie und Oberfläche; keine übernommenen Spore-Inhalte.

**Branch/Integration:** `agent/creature-editor-spore`, [Draft PR #12](https://github.com/MajorDragonfly/voxelverse/pull/12), aufbauend auf M2A/PR #10. Die Planeten- und Menüentwicklung aus PR #11 bleibt ein separater Arbeitsstrang. Die gemeinsame Render-Prüfdatei wird nur im Kreaturenfall ergänzt. Details, Bedienung, Prüfnachweise und Grenzen: [Kreaturen-Werkstatt](docs/CREATURE_STUDIO_M3A.md).

**M3 bleibt offen:** Die neue Werkstatt und die gemeinsame Darstellung sind ein konkretes Teilpaket. Schwimmen/Fliegen, komplexe Gelenkketten und die vollständige Gelände-/Fähigkeitsabnahme gehören weiterhin zur späteren M3/M4-Arbeit. M2B wird dadurch nicht als erledigt markiert.

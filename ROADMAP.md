...
| M4 | Lebendige Tierwelt und Kreaturen-Spielablauf; Skilltree und reale Begegnungen als getrennte Teilpakete | M1–M3 | UI-Ausgangspaket PR #14. Folgebranch `agent/creature-behavior-gameplay`: Befreunden/Helfen/Jagd, persistente Beziehungen und vier wirksame Kreaturenboni implementiert, lokaler Gesamtlauf bestanden; grafische/Exportabnahme läuft. Entdeckungsbuch an eigenen Chat übergeben; Nestgruppe/Begleiterbefehle separat. Herde, Nahrungssuche und vollständiges Räuber-Beute-Spiel bleiben offen. [Umfang](docs/CREATURE_BEHAVIOR_GAMEPLAY.md), [spätere Phasen](docs/BEHAVIOR_FUTURE_PHASES.md) |

...
| M1 | **Technikprototyp und Ausbau geprüft:** Kugelplanet und Sternsystemlabor | M0 | Kleine Kugeln und Aster (4.096 m Radius), adaptive Kacheln, echte Physik, Terrain-/Wassernähte, Ursprungswechsel und Sicherung geprüft. Code `6916cab`: 51 Gesamtprüfungen, je 13 native Exportprüfungen, klickbares Esc/F8-Menü und F4-/Menüeinstieg. Manueller Ziel-PC-Test und Kampagnenanbindung offen. [Grundlagen](docs/PLANET_M1.md) / [Ausbau und Nachweise](docs/PLANET_LOD_AND_MENU.md) |

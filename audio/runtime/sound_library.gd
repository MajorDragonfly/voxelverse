...
const SOUNDS := {
	...
	&"water_exit": [preload("res://audio/assets/water_exit.wav")],
	&"water_dive": [preload("res://audio/assets/water_dive.wav")],
	&"water_surface": [preload("res://audio/assets/water_surface.wav")],
	&"underwater_bubbles": [preload("res://audio/assets/underwater_bubbles_0.wav"), preload("res://audio/assets/underwater_bubbles_1.wav"), preload("res://audio/assets/underwater_bubbles_2.wav")],

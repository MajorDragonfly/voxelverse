...
Stand: 9. September 2026 · **Status: geplant** · Konkretisierung von **M9** aus der [Roadmap](../ROADMAP.md). Die Aufgabenübersicht steht in [FEATURE_BACKLOG.md](FEATURE_BACKLOG.md).

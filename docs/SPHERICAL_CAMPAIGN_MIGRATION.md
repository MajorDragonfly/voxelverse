...
Der reguläre Neue-Spiel-Start bleibt bis M1i kompatibel zur Flachwelt. Der gemeinsame Kugelstart nutzt inzwischen den normalen Spieler, Kreatureneditor, Scanner, Bedürfnisse, Heimatgruppe, Dorf und D1→D2→D3-Anschluss. `campaign_places_copy_v2` erweitert die bestehende atomare Kopiermigration auf entwickelte Bestände; ein regionaler Manifest-Speicher übernimmt Population, Bedürfnisse und Begegnungen. Neue Kugeln verwenden `living_planet_v2` mit Süßwasser; bestehende V1-Körper behalten ihre Erzeugung.

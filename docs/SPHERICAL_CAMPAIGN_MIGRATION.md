...
Neue Weltentwicklung baut auf `cube_sphere_m1_v1`, dem vorhandenen radialen Adapter und der versionierten `living_planet`-Oberfläche auf. Die aktive Flachkampagne ist aus dem regulären Spielablauf entfernt; unterstützte Altstände werden als Kugelkopie fortgesetzt. Zusätzliche Epochen und große neue planare Gameplaybereiche warten auf diesen Umzug. Bestehende Inhalte, Arten, Bewohner, Besitz, Karten, Entwürfe und Fortschritte gehören weiter zur selben Kampagne.

**Lars hat am 10. September entschieden, den regulären Spielstart jetzt vollständig auf Kugeln umzustellen; die ausstehende M1i-Abnahme ist keine Startfreigabesperre mehr.** Neue Spiele und Fortsetzen verwenden nur Kugelwelten. Die ursprünglichen Flachweltdaten bleiben über Kopiermigration und Archive erhalten. Siehe [WORK_SPHERE_ONLY_ENTRY.md](WORK_SPHERE_ONLY_ENTRY.md). Der gemeinsame Kugelstart nutzt inzwischen den normalen Spieler, Kreatureneditor, Scanner, Bedürfnisse, Heimatgruppe, Dorf und D1→D2→D3-Anschluss. `campaign_places_copy_v2` erweitert die bestehende atomare Kopiermigration auf entwickelte Bestände; ein regionaler Manifest-Speicher übernimmt Population, Bedürfnisse und Begegnungen. Neue Kugeln verwenden `living_planet_v2` mit Süßwasser; bestehende V1-Körper behalten ihre Erzeugung.

[Arbeitsstand, ausgeführte Prüfungen und offene Abnahmen](WORK_SPHERICAL_GAMEPLAY.md) sind die aktuelle Übergabe für M1f/M1g und den begonnenen M1h-Teil. Die neue Architekturprüfung ist integriert. Fernproduktion eigener Siedlungen, vollständige Langzeit-/Körperreise und die Ziel-PC-Abnahme bleiben konkrete offene Aufträge. Die M1e-Dokumentation beschreibt weiterhin den ursprünglichen engeren Stand; ihre damaligen Sperren nicht mit den inzwischen nachgewiesenen Anschlüssen verwechseln.
...
| M1i – Umschalten und Abnahme | Kugelkampagne als regulärer Neue-Spiel-Start; alte Ebene ausschließlich als Datenquelle für den Kopierumzug; gemeinsame Build- und Ziel-PC-Prüfung | Menü, Export, automatisierte Akzeptanz, Dokumentation | Vollständiger untenstehender Ablauf in einem gemeinsamen Spielstand und einem frischen Prozess bestanden |

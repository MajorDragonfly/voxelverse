...
| Speicher | Godots statischer Allokator plus unter Linux gesondert Prozess-RSS aus `/proc`. Andere Betriebssysteme erhalten für fehlendes RSS `null`. Renderallokationen sind keine Messung physisch residenten VRAMs. |

...
Stand: 10. September 2026. Ergänzt die [gemeinsame Roadmap](../ROADMAP.md) um neue Nutzerwünsche. Die Datei enthält geplante Arbeit und ausdrücklich belegte Teilabschlüsse; aktueller Stand: [Integration vom 10. September](INTEGRATION_2026-09-10.md). Die [Arbeitsaufteilung](NEXT_PARALLEL_WORK.md) und bestehenden Fachverträge bleiben die Grundlage.
...
| D3-EIER | Versorgung, Eierlegen, Sammeln, Transport und Nahrung aus eigenen Tieren | Tierhaltung und Dorfwirtschaft, D3/M6 | Nach D1-EIER, D2 und gemeinsamer D3-Haltungsbasis | Über #90 integriert: [ARCH-22](WORK_ARCH22_EGG_PRODUCTION.md); aktuelle Abnahme im Dashboard |
...
| M9-EXPEDITION | Modulares Expeditionsschiff, kleinere Landungsschiffe, Planetenuntersuchung und wachsender Schiffsausbau | Weltraumphase, M9.1–M9.6 | Nach M8 und vollständiger Kugelkampagne; Daten-/Editoranschlüsse früh vorbereiten | Datenentwurf und Schiffseditor im Kandidaten #125; Instanzen als Fachlieferung #129; Spielphase geplant |
...
Die Reihenfolge ist technisch begründet. Der Kugelwelt-Umzug ist die vorhandene gemeinsame Grundlage; seine Langzeit-/Grafikabnahme bleibt offen. M9-EXPEDITION ist eine spätere Weltraumplanung. Datenkatalog und Modelle können unabhängig davon vorbereitet werden; finale Platzierung, Bodenkontakt, Legestellen und Transporte müssen die gemeinsame radiale Oberfläche nutzen.

## D1-EIER – Eierliefernde Nutztiere im Artenkatalog

**Integration vom 10. September:** ARCH-21 liefert die vierte Rolle `eggs` samt additiver Katalogmigration, Körperprüfung und erreichbarem Habitat. D1 deklariert Menge 1 und Intervall 300 aktive Spielsekunden; die tatsächliche Legestelle/Produktion verwendet künftig ARCH-22. [Übergabe](WORK_ARCH21_EGG_SPECIES.md).
...
- [x] Eierlieferfähigkeit im vorhandenen Eignungsvertrag versioniert ergänzen. Die Kennung lautet `eggs`; die bisherigen drei Gruppen und ihre IDs bleiben erhalten.
...
- [x] Deterministische, erreichbare Vorkommen mit passendem Habitat, Nahrung und Wasser vorsehen; eine Katalogzeile allein erfüllt die Garantie nicht.
- [x] Bestehende Kataloge gezielt erweitern/migrieren, ohne ihre bisherigen Arten oder Individuen neu zu generieren. Eine zusätzliche Art erhält eine stabile Identität.
- [x] Scan und Entdeckungsbuch zeigen die tatsächlich bekannte Eier-Eignung; das eigene Tierregister liest den gespeicherten individuellen Zustand.
- [x] Mehrere Seeds, Besuchsreihenfolge, Wiederbesuch, Neustart und Altstände prüfen. Rollenverlust durch Ausrottung an die vorhandene Bestands-/Ersatzplanung anschließen.

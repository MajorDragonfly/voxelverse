...
Lars hat den Upload und die Erstellung eines Pull Requests ausdrücklich freigegeben. Der zuvor blockierte Upload ist damit geklärt. Die Veröffentlichung wurde am 15. September 2026 über den verbundenen GitHub-Zugang abgeschlossen: [PR #86](https://github.com/MajorDragonfly/voxelverse/pull/86), als Entwurf gegen `main`. Eine Übernahme in `main` ist nicht Bestandteil dieser Veröffentlichung.

Der veröffentlichte Codecommit `fe02dbbfd2d2cac714d2f48f836c5935014b0b4d` besitzt exakt denselben Dateibaum `f430ee4791976a4ce804e516f4b7fdb5de75e10a` wie der lokal geprüfte Codecommit `072c701b7b12733156827177e40dd23cb811923b`. Das vollständige Übergabepaket wurde als `736cf75a490f7552838190acbd924734163bdc6b` mit Dateibaum `47d31457d38d0262fc0ea4af7453a9867606b0e7` veröffentlicht; dies ist exakt der Dateibaum der lokalen Übergabe `46ab9a827d5a1ba1f75ed4498339674684ac31d2`. Nur die Commitmetadaten unterscheiden sich durch den GitHub-Zugang. Der anschließende Dokumentationscommit aktualisiert diesen Veröffentlichungsstatus und die Evidenzzuordnung; Spielcode und Tests bleiben unverändert.

...
**Fachlieferung, noch nicht in main integriert.** Basis:
`1d6573d9551c3f24bf1dd6fa64e5c301583a26c8` aus
`agent/integration-vegetation-nest-20260915`.

- Neues Spiel beginnt freundlich: leichter Wolkenbesatz und schwacher Wind.
  Nach 3,5–5 Kampagnenminuten zieht Bewölkung auf, nach 7–10 Minuten folgt der
...
- Wind bleibt bei 1,2–4,8 m/s; Regen höchstens 0,65 der Darstellungsintensität.
  Kein Blitz, Feuer, Sandsturm, Temperaturstress oder Wetterschaden. In dieser
  Lieferung verwenden **alle** regulären Kampagnenkörper dieses milde Profil.
...
`world/weather/weather_model.gd` ist eine reine Ableitung. Eingaben sind stabile
...
| `cloud_cover`, `precipitation`, `wetness` | Normierte Bewölkung, Regenstärke, abklingende Oberflächennässe |
...
| `front_index`, `seconds_to_next_front` | Deterministische Frontnummer und Zeit bis zur nächsten Front |
...
**Budget:** zwei MultiMeshes, 384 vorallozierte Regentropfen und 96 Wolkenblöcke;
...
2 Hz), dazu eine radiale Wassersichtprobe je Physiktick. Unbekannter Boden
...
Einzeltropfen-Kollisionssimulation. Wolken sind eine kameraumgebende lokale
Darstellung; regionale Wetterzellen gehören zum Folgepaket.

## Folgepakete und Grenzen

| Paket | Lieferung | Abnahme vor Freigabe |
|---|---|---|
| WEATHER-02 – planetare Klimazonen | Versionierte Klimaprofile pro stabiler Körper-ID; Herkunftsplanet dauerhaft identifizieren und mild schützen; atmosphärenlose, trockene, eisige, vulkanische Welten; regionale Fronten und Biomübergänge | Startplanet bleibt bei allen Seeds, Migration, Körperreise und Neustart ungefährlich; kein Regen im Vakuum; kein Wetterwechsel an Cube-Nähten; unbekannte Save-Version geschützt |
...
Normal starten und 7–10 Kampagnenminuten spielen. Für unmittelbare Sichtprüfung
...
`clear`, `breeze`, `overcast`, `drizzle`, `rain`. Unbekannte oder extreme Namen

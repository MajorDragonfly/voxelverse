...
Alle Folgearbeiten starten vom veröffentlichten gemeinsamen Commit. Ein Fachpaket liefert exakten Commit, Vertragsversionen, veränderte Dateien, Tests und offene Grenzen. Die Integration prüft gegenseitige Abhängigkeiten erneut; Einzelbranch-Nachweise gelten nicht automatisch für den Gesamtstand. Gemeinsame technische Verträge sowie Integrations-/Teststände werden durch die Integration gepflegt. Neue Ideen und ihre Roadmap-Einordnung pflegt gemäß Lars' Auftrag der Roadmap-Chat in [FEATURE_BACKLOG.md](FEATURE_BACKLOG.md); geplante Erweiterungen ändern keine bestehenden Abschlussnachweise. Keine fremden unfertigen Arbeitsstände übernehmen.
...
## Geplante Ideen nach den laufenden Grundarbeiten

Die folgenden Wünsche sind erfasst und haben noch keinen Implementierungsstatus. Sie ersetzen keinen der vorstehenden Umzugsaufträge.

| Paket | Geplante Ergänzung | Anschluss |
|---|---|---|
| D1-EIER | Eierlieferfähigkeit und zusätzliche geeignete Art je belebtem Spielplaneten | Vorhandenen D1-Vertrag versioniert erweitern; Art-/Tier-IDs und Altstände erhalten |
| D3-EIER | Versorgung, Legestelle, Sammeln, Transport und Eier als Nahrung | Vorhandenen D2-Tierbestand und D3-Dorfwirtschaft verwenden; radiale Laufzeit anschließen |
| M3-TEILE | Alle Körperteile prüfen/überarbeiten; konkrete Tierformen frei kombinieren | Gemeinsame Körperanschlüsse, [Katalogplan](CREATURE_PARTS_CATALOG_PLAN.md) und fünf abgegrenzte Unteraufgaben |
| M9-EXPEDITION | Großes modulares Expeditionsschiff, kleinere Landungsschiffe und wachsender Ausbau | Nach M8 und vollständiger Kugelkampagne; [Expeditionsplan](SPACE_EXPEDITION_PLAN.md), M9.1–M9.6 |
| BP-COMMUNITY | Gemeinsame Vorlagenbibliothek und Community-Upload/Download für Kreaturen, Gebäude, Fahrzeuge und Schiffe | Früher Format-/Editoranschluss, erster vollständiger Online-Austausch für Kreaturen; [Community-Designplan](COMMUNITY_DESIGNS_PLAN.md), fünf Unterpakete |

Entdeckungsbuch, UI, Übersetzungen, Forschung, Speicher- und Weltadressen werden über die vorhandenen gemeinsamen Dienste angeschlossen. Alle Editorbereiche verwenden denselben Bauplan-/Bibliotheksvertrag; eine passende fertige Vorlage muss ohne eigene Editorarbeit nutzbar sein. Die Eierkette wartet nicht auf den vollständigen Körperteilkatalog. Weltraum-Anschlüsse werden bei Grundlagen berücksichtigt; neue Flug-, Hangar- und Flottenspielschleifen gehören erst in die spätere M9-Runde.

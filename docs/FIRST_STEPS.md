...
Neue Abenteuer erhalten eine kleine Einführung am unteren linken Bildschirmrand. Vier Grundlagen werden durch tatsächlich ausgeführte Aktionen erkannt: ungefähr 32 Grad mit der Spielkamera umschauen, vier Meter selbst gesteuert zurücklegen, vom Boden abspringen und die Daten einer Kreatur im Untersuchungsmodus anzeigen lassen. Die Reihenfolge ist frei. Bereits erledigte Aufgaben müssen nicht wiederholt werden; die Karte zeigt jeweils die erste offene Aufgabe.

Die Hinweise verwenden die aktuell gespeicherten Tastenbelegungen. Beim Untersuchen unterscheiden sie zwischen dem Öffnen des Modus und dem Annähern an eine Kreatur. Die vorhandenen situationsabhängigen Hinweise für Kreaturen, Nahrung und Wasser bleiben an denselben Spielaktionen angeschlossen. Die Einführung ist eine Ergänzung der vorhandenen Hilfe.
...
- `ui/creature_inspection_hud.gd` meldet Untersuchung erst, wenn ein tatsächliches Ziel gültige Untersuchungsdaten liefert. Das bloße Einschalten des Modus reicht nicht aus.
...
Es werden keine Kampagnenereignisse, Belohnungen, Skilltree-Punkte oder Entdeckungen erzeugt. Die Einführung nutzt die bestehenden Spieler- und Untersuchungsfunktionen. Bei späterer Integration der anderen Arbeitszweige sind die beiden kleinen Signalanschlüsse im Spieler und im Untersuchungspanel zu übernehmen.

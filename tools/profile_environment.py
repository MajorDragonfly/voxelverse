...
def main():
    ...
    parser.add_argument("--cases", nargs="+", choices=["world", "assets", "species", "cluster", "creature", "water", "hydrology", "planet_lab", "large_planet", "underwater"], default=["world", "assets", "species", "cluster", "creature", "water", "hydrology"])

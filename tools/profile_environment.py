...
def main():
    ...
    parser.add_argument("--cases", nargs="+", choices=["world", "assets", "species", "cluster", "creature", "water", "hydrology", "planet_lab"], default=["world", "assets", "species", "cluster", "creature", "water", "hydrology"])

...
func _check_catalog() -> void:
	...
	var additions: Array = ["feet_feline_paws", "feet_bear_paws", "feet_horse_hooves", "hands_crab_claws", "mouth_canine_snout", "mouth_crocodile_snout", "mouth_octopus_beak", "head_elephant_trunk", "mouth_feline_snout", "mouth_bear_snout", "mouth_pig_snout", "tail_stump", "tail_reptile", "tail_beaver_paddle", "tail_horizontal_fluke", "wings_broad_feather", "wings_slender_feather", "wings_bat_membrane", "wings_long_insect", "fins_broad_paddle", "fins_slender_steering", "fins_round_side", "fins_tall_dorsal", "fins_long_fringe", "fins_small_stabilizer", "ears_cat_pointed", "ears_bear_round", "ears_rabbit_long", "ears_dog_floppy", "ears_elephant_broad", "ears_bat_large", "horns_stag_antlers", "horns_moose_antlers", "decor_low_crest", "decor_saw_crest", "decor_head_crest", "decor_frill"]

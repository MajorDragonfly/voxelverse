...
func run() -> void:
	...
	# Optional progression autoload is connected at runtime, without importing it.
	var progression := ProgressionFixture.new()
	...
	check(ui_playing, "Successful discovery signal produces feedback")
